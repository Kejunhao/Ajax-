...
('def', 'newsbaidu', 'baijia', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'newsbaidu', 'baijia', 'title', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'newsbaidu', 'baijia', 'content', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8mb4', 'utf8mb4_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'newsbaidu', 'baijia', 'time', 4, NULL, 'NO', 'date', NULL, NULL, NULL, NULL, NULL, NULL, 'date', '', '', 'select,insert,update,references', ''),
('def', 'newsbaidu', 'baijia', 'img', 5, NULL, 'NO', 'varchar', 300, 1200, NULL, NULL, 'utf8mb4', 'utf8mb4_general_ci', 'varchar(300)', '', '', 'select,insert,update,references', ''),
('def', 'newsbaidu', 'baijia', 'cat', 6, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', '', '', 'select,insert,update,references', ''),
...
('def', 'test', 'content', 'receiver', 1, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8mb4', 'utf8mb4_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'test', 'content', 'con', 2, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'utf8mb4', 'utf8mb4_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'test', 'message', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(100)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'test', 'message', 'msg', 2, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8mb4', 'utf8mb4_unicode_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'test', 'message', 'sender', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8mb4', 'utf8mb4_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'test', 'message', 'receiver', 4, NULL, 'NO', 'varchar', 300, 1200, NULL, NULL, 'utf8mb4', 'utf8mb4_general_ci', 'varchar(300)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'message', 'color', 5, NULL, 'YES', 'varchar', 300, 1200, NULL, NULL, 'utf8mb4', 'utf8mb4_general_ci', 'varchar(300)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'message', 'biaoqing', 6, NULL, 'YES', 'varchar', 300, 1200, NULL, NULL, 'utf8mb4', 'utf8mb4_general_ci', 'varchar(300)', '', '', 'select,insert,update,references', ''),
('def', 'test', 'message', 'add_time', 7, NULL, 'YES', 'datetime', NULL, NULL, NULL, NULL, NULL, NULL, 'datetime', '', '', 'select,insert,update,references', '');
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '20'),
('HANDLER_READ_FIRST', '3535'),
('HANDLER_READ_KEY', '3527'),
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '0'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '0'),
('HANDLER_READ_RND_NEXT', '45060'),
('HANDLER_ROLLBACK', '0'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '0'),
('HANDLER_WRITE', '2485'),
('INNODB_BUFFER_POOL_PAGES_DATA', '173'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '138'),
('INNODB_BUFFER_POOL_PAGES_FREE', '8018'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '50580'),
('INNODB_BUFFER_POOL_READS', '166'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '141'),
('INNODB_DATA_FSYNCS', '114'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '4902912'),
('INNODB_DATA_READS', '176'),
('INNODB_DATA_WRITES', '154'),
('INNODB_DATA_WRITTEN', '2301440'),
('INNODB_DBLWR_PAGES_WRITTEN', '69'),
('INNODB_DBLWR_WRITES', '24'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '22'),
('INNODB_LOG_WRITES', '36'),
('INNODB_OS_LOG_FSYNCS', '61'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '27648'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '8'),
('INNODB_PAGES_READ', '165'),
...
('THREADS_CACHED', '0'),
('THREADS_CONNECTED', '1'),
('THREADS_CREATED', '3548'),
('THREADS_RUNNING', '1'),
('UPTIME', '9868'),
('UPTIME_SINCE_FLUSH_STATUS', '9868');
...
('PLUGIN_DIR', 'D:\\Download\\wamp\\bin\\mysql\\mysql5.5.20\\lib/plugin'),
('PERFORMANCE_SCHEMA_MAX_RWLOCK_INSTANCES', '1000000'),
('LOG_SLOW_QUERIES', 'OFF'),
('PERFORMANCE_SCHEMA_MAX_RWLOCK_CLASSES', '30'),
('BASEDIR', 'D:/Download/wamp/bin/mysql/mysql5.5.20'),
...
('CHARACTER_SETS_DIR', 'D:\\Download\\wamp\\bin\\mysql\\mysql5.5.20\\share\\charsets\\'),
('LOG_BIN', 'ON'),
...
('THREAD_CACHE_SIZE', '0'),
('LC_MESSAGES_DIR', 'D:\\Download\\wamp\\bin\\mysql\\mysql5.5.20\\share\\'),
...
('PID_FILE', 'D:\\Download\\wamp\\bin\\mysql\\mysql5.5.20\\data\\DESKTOP-11UJVPF.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'latin1_swedish_ci'),
('GENERAL_LOG_FILE', 'D:\\Download\\wamp\\bin\\mysql\\mysql5.5.20\\data\\DESKTOP-11UJVPF.log'),
('FLUSH_TIME', '1800'),
...
('SLOW_QUERY_LOG_FILE', 'D:\\Download\\wamp\\bin\\mysql\\mysql5.5.20\\data\\DESKTOP-11UJVPF-slow.log'),
('CHARACTER_SET_SYSTEM', 'utf8'),
('SYSTEM_TIME_ZONE', ''),
('DIV_PRECISION_INCREMENT', '4'),
('OPTIMIZER_PRUNE_LEVEL', '1'),
('DATADIR', 'D:\\Download\\wamp\\bin\\mysql\\mysql5.5.20\\data\\'),
...
('LOG_ERROR', 'D:\\Download\\wamp\\logs\\mysql.log'),
...
('def', 'newsbaidu', 'PRIMARY', 'def', 'newsbaidu', 'baijia', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'test', 'PRIMARY', 'def', 'test', 'message', 'id', 1, NULL, NULL, NULL, NULL);
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-11-04 04:53:42', '2019-11-04 04:53:42', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-11-04 04:53:42', '2019-11-04 04:53:42', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-11-04 04:53:42', '2019-11-04 04:53:42', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-11-04 04:53:42', '2019-11-04 04:53:42', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-11-04 04:53:42', '2019-11-04 04:53:42', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-11-04 04:53:42', '2019-11-04 04:53:42', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-11-04 04:53:42', '2019-11-04 04:53:42', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-11-04 04:53:42', '2019-11-04 04:53:42', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-11-04 04:53:42', '2019-11-04 04:53:42', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2019-11-04 04:53:42', NULL, NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'db', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 440, 880, 123848989752688639, 5120, 0, '2011-12-16 21:03:08', '2012-01-25 00:47:18', '2011-12-16 21:03:09', NULL, '', '', NULL),
('def', 'mysql', 'event', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 2048, 0, '2011-12-16 21:03:09', '2012-01-25 00:47:18', NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'proxies_priv', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 693, 693, 195062158860484607, 5120, 0, '2011-12-16 21:03:09', '2012-01-25 00:47:20', '2011-12-16 21:03:09', NULL, '', '', NULL),
...
('def', 'mysql', 'user', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 4, 53, 212, 281474976710655, 2048, 0, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, NULL, '', '', NULL),
('def', 'newsbaidu', 'baijia', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 8, 2048, 16384, NULL, 0, 0, '2019-10-31 15:22:28', NULL, NULL, NULL, '', '', NULL),
...
('def', 'test', 'content', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 12, 1365, 16384, NULL, 0, 0, '2019-10-31 14:58:50', NULL, NULL, NULL, '', '', NULL),
('def', 'test', 'message', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-10-31 09:28:08', NULL, NULL, NULL, '', '', NULL);
...
(3548, 'root', 'localhost:49507', NULL, 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'newsbaidu', 'latin1', 'latin1_swedish_ci', NULL),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '50665'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '9869'),
('UPTIME_SINCE_FLUSH_STATUS', '9869');
...
('def', 'newsbaidu', 'baijia', 0, 'newsbaidu', 'PRIMARY', 1, 'id', 'A', 8, NULL, NULL, '', 'BTREE', '', ''),
('def', 'test', 'message', 0, 'test', 'PRIMARY', 1, 'id', 'A', 0, NULL, NULL, '', 'BTREE', '', '');
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-11-04 04:53:42', '2019-11-04 04:53:42', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-11-04 04:53:42', '2019-11-04 04:53:42', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-11-04 04:53:42', '2019-11-04 04:53:42', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-11-04 04:53:42', '2019-11-04 04:53:42', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-11-04 04:53:42', '2019-11-04 04:53:42', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-11-04 04:53:42', '2019-11-04 04:53:42', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-11-04 04:53:42', '2019-11-04 04:53:42', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-11-04 04:53:42', '2019-11-04 04:53:42', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-11-04 04:53:42', '2019-11-04 04:53:42', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2019-11-04 04:53:42', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
...
('def', 'mysql', 'db', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 2, 440, 880, 123848989752688639, 5120, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 00:47:18', '2011-12-16 21:03:09', 'utf8_bin', NULL, '', 'Database privileges'),
('def', 'mysql', 'event', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 0, 0, 0, 281474976710655, 2048, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 00:47:18', NULL, 'utf8_general_ci', NULL, '', 'Events'),
...
('def', 'mysql', 'proxies_priv', 'BASE TABLE', 'MyISAM', 10, 'Fixed', 1, 693, 693, 195062158860484607, 5120, 0, NULL, '2011-12-16 21:03:09', '2012-01-25 00:47:20', '2011-12-16 21:03:09', 'utf8_bin', NULL, '', 'User proxy privileges'),
...
('def', 'mysql', 'user', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 4, 53, 212, 281474976710655, 2048, 0, NULL, '2011-12-16 21:03:08', '2012-01-25 00:47:20', NULL, 'utf8_bin', NULL, '', 'Users and global privileges'),
('def', 'newsbaidu', 'baijia', 'BASE TABLE', 'InnoDB', 10, 'Compact', 8, 2048, 16384, 0, 0, 9437184, 22, '2019-10-31 15:22:28', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', ''),
...
('def', 'test', 'content', 'BASE TABLE', 'InnoDB', 10, 'Compact', 12, 1365, 16384, 0, 0, 9437184, NULL, '2019-10-31 14:58:50', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'test', 'message', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 9437184, 1, '2019-10-31 09:28:08', NULL, NULL, 'utf8mb4_unicode_ci', NULL, '', '');
...
('def', 'newsbaidu', 'PRIMARY', 'newsbaidu', 'baijia', 'PRIMARY KEY'),
('def', 'test', 'PRIMARY', 'test', 'message', 'PRIMARY KEY');
...
-- 数据库: `newsbaidu`
--
CREATE DATABASE `newsbaidu` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `newsbaidu`;
...
(1, '2020国考报名今将截止 近百万人已通过资格审查', '中新网客户端北京10月24日电(冷昊阳)今日18时，2020年国考网上报名通道将关闭。根据国家公务员局公布的数据，截至23日18时，已有近百万人通过资格审查，多个岗位竞争程度超过“千里挑一”，不过仍有超过240个职位“无人问津”。\r\n截至23日18时 近百万人已过审\r\n\r\n按照国家公务员局此前发布的报名安排，今日(24日)18时，2020年国考网上报名阶段将截止。在报名是最后阶段，国考的报名过审人数也增加明显。\r\n\r\n23日晚，国家公务员局发布了本次国考最新的报考情况数据。记者统计，截至23日18时，已有超过99.4万人通过资格审查。\r\n\r\n\r\n', '2019-10-11', 'img\\img1.jpg', 0),
(3, '被土耳其告知将“永久”停火，特朗普宣布解除对土制裁', '【环球网报道 记者 温家越】俄土就叙利亚局势达成协议后，当地时间23日，美国总统特朗普在白宫就叙利亚最新局势发表声明。鉴于土耳其政府已告知美国，土方将停止在叙利亚境内的军事行动、实现“永久性”停火，美方会解除对土耳其的所有制裁。\r\n\r\n据英国《卫报》23日报道，特朗普当天在白宫表示：“土耳其政府通知我们，他们将停止在叙利亚的战斗和攻势，永久停火，”他接着说，“因此，我已指示财政部长姆努钦，解除从10月14日以来对土耳其实施的制裁，除非发生我们不乐见的情况。”', '2019-10-14', 'img\\img3.jpg', 0),
(5, 'second page1', 'content', '2016-02-04', 'img\\img5.jpg', 1),
(6, 'second page3', 'content', '2016-02-18', 'img\\img6.jpg', 1),
(8, 'third page', 'content', '2016-02-09', 'img\\img6.jpg', 2),
(9, 'third page', 'content', '2016-02-09', 'img\\img6.jpg', 2),
(10, 'third page1', 'content', '2016-02-09', 'img\\img6.jpg', 2),
(21, '珍爱和平团结合作 构建人类命运共同体——习近平主席致第九届北京香山论坛贺信引起热烈反响', '新华社北京10月23日电（记者胥舒骜、王逸涛、任垚媞） “维护亚太地区持久和平安宁，符合地区国家共同利益，需要各国贡献智慧和力量。”中国国家主席习近平21日致第九届北京香山论坛的贺信，在与会中外嘉宾中引起热烈反响。\r\n\r\n　　维护和平符合全人类的共同利益\r\n\r\n　　“和平是人类的永恒期望。中国坚持以对话促合作、以合作促和平、以和平保发展。”习主席贺信中的话，引发了参会人员的广泛共鸣。\r\n\r\n　　“中国在维护国际安全和世界和平方面不懈努力，习主席再次向全世界明确宣示了中国坚定不移走和平发展道路的决心。”军事科学院战争研究院研究员于淼说，面对百年未有之大变局，中国从原则、方法、路径等方面提出了推动世界和平的“中国方案”。\r\n\r\n　　“中国不仅承担着作为联合国安理会常任理事国应开展的维和任务，并且现在已成为联合国维和经费的第二大出资国。”联合国副秘书长哈雷对中国在维和行动中的付出“点赞”，“在安理会常任理事国中，中国派出的维和人员数量最多，工程师团队也非常优秀。”\r\n\r\n　　“习近平主席的贺信表达了中国对于地区与世界和平的关切。”西南政法大学军事法研究所所长潘国平认为，中国对和平的呼吁与贡献构筑了与会嘉宾的最大同心圆。\r\n\r\n　　新型安全伙伴关系值得期待\r\n\r\n　　习近平主席在贺信中强调，各国要紧密团结起来，坚定维护以联合国为核心的国际体系，不断完善新型安全伙伴关系，推动构建符合地区发展实际的安全架构，更好促进亚太地区持久和平和普遍安全。\r\n\r\n　　“习主席的贺信彰显了维护和平、团结协作、对话沟通的安全理念。”军事科学院副院长皮明勇说，单边主义对国际体系构成挑战和冲击，对世界和平稳定构成威胁，需要各国携手并肩、共同面对。\r\n\r\n　　“各国需秉持相互尊重、对话协商、开放包容、合作共赢的时代精神，推动建立新型安全伙伴关系，通过加强交流合作、共同应对挑战，走出一条对话不对抗、结伴不结盟的国家间交往新路。”国防大学国家安全学院副教授张弛说。\r\n\r\n　　尼泊尔副总理兼国防部长博克瑞尔高度评价习近平主席的贺信并表示，习近平主席日前对尼泊尔的访问对尼中关系意义重大，尼方希望与中方不断找到共同立场，制定出实实在在的计划，推进两国关系不断向前发展。', '2019-10-10', 'img\\xinhua.jpg', 0);
--
...
CREATE TABLE IF NOT EXISTS `content` (
  ...
  `con` text CHARACTER SET utf8mb4
...
CREATE TABLE IF NOT EXISTS `message` (
  ...
  `sender` text CHARACTER SET utf8mb4 NOT NULL,
  `receiver` varchar(300) CHARACTER SET utf8mb4 NOT NULL,
  `color` varchar(300) CHARACTER SET utf8mb4 DEFAULT NULL,
  `biaoqing` varchar(300) CHARACTER SET utf8mb4 DEFAULT NULL,
